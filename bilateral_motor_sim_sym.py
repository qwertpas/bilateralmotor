...
class BilateralMotorSimulation:
    ...
    def __init__(self):
        ...
        self.visualization_interval = 16  # ~60 FPS (16ms between frames)
        ...
        self.timer = None  # Timer object for animation
        
        # Controller parameters
        self.kp = 1000.0  # Proportional gain
    ...
    def setup_plot(self):
        ...
        # Position lines
        self.line_motor1_pos, = self.ax1.plot([], [], 'b-', marker='.', label='Motor 1')
        self.line_motor2_pos, = self.ax1.plot([], [], 'r-', marker='.', label='Motor 2')
        self.ax1.legend()
        ...
        # Add pause button
        self.ax_pause_button = plt.axes([0.8, 0.25, 0.1, 0.04])
        self.pause_button = Button(self.ax_pause_button, 'Pause')
    ...
    def update_simulation(self):
        ...
        # self.motor1.target_velocity = 0
        # self.motor2.target_velocity = 0

        # with delay
        delay_samples = 10
        self.motor1.target_position = self.motor2_position_history[-delay_samples]
        # self.motor2.target_position = self.motor1_position_history[-delay_samples]
        self.motor2.target_position = self.motor1_position_history[-1]
        self.motor1.target_velocity = 0
        self.motor2.target_velocity = 0
    ...
    def toggle_pause(self, event):
        """Callback for pause button - toggles pause state"""
    ...
    def run(self):
        ...
        self.timer = self.fig.canvas.new_timer(interval=self.visualization_interval)  # interval in milliseconds
    ...
    def animation_step(self):
        ...
        if not self.is_paused:
            ...
            steps_per_frame = max(1, int(self.visualization_interval / (self.dt * 1000)))
